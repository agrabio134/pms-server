...
$(document).ready(function(){
    $('.search-box1 input[type="text"]').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("backend-search.php", {num_term: inputVal}).done(function(data){
                resultDropdown.html(data);
            });
        } else{
            resultDropdown.empty();
...
<div class="main-container">
    ...
    <!-- <input type="text" > -->
        <input type="text" class="emp" name="email" autocomplete="off" placeholder="Search Email Address..." />
    ...
    <div class="slip-item-container">
        ...
        <input type="text" class="emp" name="emp_number" autocomplete="off" placeholder="Re-Enter Email Address..." />
