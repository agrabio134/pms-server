...
if (isset($_POST['compute'])) {
    ...
    $n_sal = $g_sal - $tax - $sss + $bonus;




    $myfile = fopen("./uploads/payroll.txt", "w") or die("Unable to open file!");
...
extract($_POST);
    ...
    if($qry->num_rows > 0){
		$emp = $qry->fetch_array();
		$save_log= $conn->query("INSERT INTO salary (gross_salary,tax,sss,net_salary,users_id) 
        values('$g_sal','$tax','$sss','$n_sal','".$emp['id']."')");
